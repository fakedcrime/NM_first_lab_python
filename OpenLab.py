...
layout = [
    [gui.Text('Введите правую границу вычислений по времени'), gui.HSeparator(pad=(50, 0)), gui.Text(key='Help'),
     gui.HSeparator(pad=(50, 0)),
     gui.Table(values=values, expand_x=True, headings=headings, key='Table', expand_y=True, auto_size_columns=True,
